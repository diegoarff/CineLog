...
const DetailsScreen = ({ mediaType, id }) => {
  ...
  const { data, isLoading } = useDetailsQuery(mediaType, id);
          ...
          <>
            ...
            <View className="-mt-12 flex-1 px-4 pb-8">
              ...
              <View className="mt-6 gap-6">
                ...
                <Pressable
                  onPress={() =>
                    router.push(`/${mediaType}/${data._id}/reviews`)
                  }
                >
                  <View className="gap-2">
                    <CustomText variant="button" className="text-baseMedium">
              ...
              <Pressable
                onPress={() => router.push(`/${mediaType}/${data._id}/reviews`)}
